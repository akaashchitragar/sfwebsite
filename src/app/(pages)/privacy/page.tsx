...
export const metadata: Metadata = {
  title: 'Privacy Policy | Sangha Chadvam',
  description: 'Privacy policy for Sangha Chadvam platform and services.',
};
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose max-w-none bg-white rounded-lg p-6 shadow-sm">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3 text-green-700">Sharing</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3 text-green-700">Security Precautions</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3 text-green-700">Data Deletion and Retention</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3 text-green-700">Your Rights</h2>
            <p className="text-gray-700">
              You may access, rectify, and update your personal data directly through the functionalities provided on the Platform.
            </p>

            <h2 className="text-xl font-semibold mt-6 mb-3 text-green-700">Consent</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-xl font-semibold mt-6 mb-3 text-green-700">Changes to this Privacy Policy</h2>
            <p className="text-gray-700">
